package com.cristianboicuchatbot.findyourcoursechatbot;
...
public class MainActivity extends AppCompatActivity {
        ...
        private void createServices() {
            watsonAssistant = new Assistant("2020-05-08", new IamAuthenticator(mContext.getString(R.string.assistant_apikey)));
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mAdapter = new ChatAdapter((Adapter)messageArrayList);
